...
- **Invoked by:** `/orb-explore`, `/orb-run`
- **Writes to:** `src/docs/` (domain specs: `spec.md` for scenarios, `impl.md` for technical details)
...
- **Invoked by:** `/orb-verify`, `/orb-run`
- **Writes to:** `src/docs/` (verified specs: `spec.md` + `impl.md`)
...
- **Invoked by:** `/orb-architect`, `/orb-run`
- **Reads from:** `src/docs/` (`spec.md` for test structure, `impl.md` for recipes/API), `src/` (framework)
...
- **Invoked by:** `/orb-write-tests`, `/orb-run`
- **Reads from:** `src/` (framework, pages, fixtures, `spec.md` for scenarios, `impl.md` for implementation)
